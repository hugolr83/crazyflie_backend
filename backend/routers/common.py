...
@router.get("/drones", response_model=list[DroneModel])
...
@router.post("/start_mission", response_model=list[DroneModel])
...
@router.post("/end_mission", response_model=list[DroneModel])
...
@router.post("/return_to_base", response_model=list[DroneModel])
